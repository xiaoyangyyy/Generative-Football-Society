...
const MANAGER_WORLD_RENDER_STAGES=Object.freeze([renderManagerWorldNavigatorBase,renderManagerWorldStory,renderManagerWorldStoryDossier,renderManagerWorldStorySocietyChanges,renderManagerWorldActionAdoptionLedger,renderManagerWorldTrajectory,renderManagerWorldReviewedFutureContinuity,renderManagerWorldScenarioArchive,renderManagerWorldReviewCertificate,renderManagerWorldReviewInfluence,renderManagerWorldRetainedRecordSemantics,renderManagerWorldTransitionPropagation,renderManagerWorldActionTransitionMap,renderManagerWorldExactActionExpectation,renderManagerWorldActionTransitionDrilldown]);
