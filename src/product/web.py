...
const renderManagerDecisionLedgerWithoutMetaLearningSummary=renderManagerDecisionLedger;
renderManagerDecisionLedger=season=>{renderManagerDecisionLedgerWithoutMetaLearningSummary(season);const summary=season?.manager_decision_ledger?.summary?.manager_world_evolution;if(summary?.meta_learning_pending||summary?.meta_learning_authorized){managerDecisionLedgerSummary.textContent+=' \u00b7 Meta \u5f85\u8bc4\u4f30 '+Number(summary.meta_learning_pending||0)+' / \u5df2\u6388\u6743 '+Number(summary.meta_learning_authorized||0)}};
