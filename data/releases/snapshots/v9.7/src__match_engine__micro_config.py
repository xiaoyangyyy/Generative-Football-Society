...
class MicroMatchConfig(AffectiveConfig):
    ...
    enable_subtick_reception_queue: bool = False
    subtick_reception_provider: str = "skillcorner"
    subtick_pass_artifact: str = "data/frame_world/frame_world_v85_pass_triplet_lodo_skillcorner.pt"
    subtick_response_blend: float = 0.5
    # --- grid ---
    grid_nx: int = 32
    grid_ny: int = 22
